...
- (void)callCompletionsWithQueue:(nonnull dispatch_queue_t)queue remove:(BOOL)remove withImage:(nullable PINImage *)image animatedImage:(nullable FLAnimatedImage *)animatedImage response:(NSURLResponse *)response cached:(BOOL)cached error:(nullable NSError *)error;
