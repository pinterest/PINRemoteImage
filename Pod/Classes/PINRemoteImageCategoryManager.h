...
@protocol PINRemoteBackgroundImageCategory;
...
+ (void)setBackgroundImageOnView:(nonnull id <PINRemoteBackgroundImageCategory>)view
                         fromURL:(nullable NSURL *)url;
...
@protocol PINRemoteBackgroundImageCategory <PINRemoteImageCategory>
...
/**
 ...
 @param url NSURL to fetch from.
 */
- (void)pin_setBackgroundImageFromURL:(nullable NSURL *)url;
...
/**
 ...
 @param placeholderImage PINImage to set on the view while the image at URL is being retrieved.
 */
- (void)pin_setBackgroundImageFromURL:(nullable NSURL *)url placeholderImage:(nullable PINImage *)placeholderImage;
...
/**
 ...
 @param completion Called when url has been retrieved and set on view.
 */
- (void)pin_setBackgroundImageFromURL:(nullable NSURL *)url completion:(nullable PINRemoteImageManagerImageCompletion)completion;
...
/**
 ...
 @param completion Called when url has been retrieved and set on view.
 */
- (void)pin_setBackgroundImageFromURL:(nullable NSURL *)url placeholderImage:(nullable PINImage *)placeholderImage completion:(nullable PINRemoteImageManagerImageCompletion)completion;
...
/**
 ...
 @param processor PINRemoteImageManagerImageProcessor processor block which should return the processed image.
 */
- (void)pin_setBackgroundImageFromURL:(nullable NSURL *)url processorKey:(nullable NSString *)processorKey processor:(nullable PINRemoteImageManagerImageProcessor)processor;
...
/**
 ...
 @param processor PINRemoteImageManagerImageProcessor processor block which should return the processed image.
 */
- (void)pin_setBackgroundImageFromURL:(nullable NSURL *)url placeholderImage:(nullable PINImage *)placeholderImage processorKey:(nullable NSString *)processorKey processor:(nullable PINRemoteImageManagerImageProcessor)processor;
...
/**
 ...
 @param completion Called when url has been retrieved and set on view.
 */
- (void)pin_setBackgroundImageFromURL:(nullable NSURL *)url processorKey:(nullable NSString *)processorKey processor:(nullable PINRemoteImageManagerImageProcessor)processor completion:(nullable PINRemoteImageManagerImageCompletion)completion;
...
/**
 ...
 @param completion Called when url has been retrieved and set on view.
 */
- (void)pin_setBackgroundImageFromURL:(nullable NSURL *)url placeholderImage:(nullable PINImage *)placeholderImage processorKey:(nullable NSString *)processorKey processor:(nullable PINRemoteImageManagerImageProcessor)processor completion:(nullable PINRemoteImageManagerImageCompletion)completion;
...
/**
 ...
 @param urls NSArray of NSURLs sorted in increasing quality
 */
- (void)pin_setBackgroundImageFromURLs:(nullable NSArray <NSURL *> *)urls;
...
/**
 ...
 @param placeholderImage PINImage to set on the view while the image at URL is being retrieved.
 */
- (void)pin_setBackgroundImageFromURLs:(nullable NSArray <NSURL *> *)urls placeholderImage:(nullable PINImage *)placeholderImage;
...
/**
 ...
 @param completion Called when url has been retrieved and set on view.
 */
- (void)pin_setBackgroundImageFromURLs:(nullable NSArray <NSURL *> *)urls placeholderImage:(nullable PINImage *)placeholderImage completion:(nullable PINRemoteImageManagerImageCompletion)completion;

- (void)pin_setBackgroundPlaceholderWithImage:(nullable PINImage *)image;

- (void)pin_updateUIWithBackgroundImage:(nullable PINImage *)image animatedImage:(nullable FLAnimatedImage *)animatedImage;
