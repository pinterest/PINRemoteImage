...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [[[PINRemoteImageManager sharedImageManager] cache] removeCachedObjectForKey:[[PINRemoteImageManager sharedImageManager] cacheKeyForURL:progressiveURL processorKey:nil]];
